...
export class CaptchaDirective {
  ...
  generateCaptcha() {
    ...
    // this.renderer.setStyle(captchaContainer, 'background', 'background: background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(9,9,121,0.6811099439775911) 35%, rgba(0,212,255,1) 100%)');
